...
# Generates all standard graphs from simulation data
...
parallel_files <- list.files(pattern = "parallel_sim_results_.*\\.csv$", full.names = TRUE)
runmodel_files <- list.files(pattern = "runmodel_results_.*\\.csv$", full.names = TRUE)
quick_files <- list.files(pattern = "quick_sim_results_.*\\.csv$", full.names = TRUE)

all_files <- c(parallel_files, runmodel_files, quick_files)
...
ggsave("plot_traits_evolution.png", plot_traits, width = 10, height = 6, dpi = 300)
cat("Saved: plot_traits_evolution.png\n")
...
ggsave("plot_sperm_evolution.png", plot_sperm, width = 10, height = 6, dpi = 300)
cat("Saved: plot_sperm_evolution.png\n")
...
ggsave("plot_rsc_evolution.png", plot_rsc, width = 10, height = 6, dpi = 300)
cat("Saved: plot_rsc_evolution.png\n")
...
ggsave("plot_correlation_evolution.png", plot_cor, width = 10, height = 6, dpi = 300)
cat("Saved: plot_correlation_evolution.png\n")
...
ggsave("plot_all_replicates_sperm.png", plot_all_sperm, width = 12, height = 8, dpi = 300)
cat("Saved: plot_all_replicates_sperm.png\n")
...
ggsave("plot_all_replicates_rsc.png", plot_all_rsc, width = 12, height = 8, dpi = 300)
cat("Saved: plot_all_replicates_rsc.png\n")
...
ggsave("plot_sperm_vs_rsc.png", plot_sperm_rsc, width = 10, height = 8, dpi = 300)
cat("Saved: plot_sperm_vs_rsc.png\n")

cat("\n=== ALL PLOTS GENERATED ===\n")
cat("Total plots created: 7\n")
